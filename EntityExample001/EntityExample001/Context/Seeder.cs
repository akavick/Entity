...
namespace EntityExample001.Context
{
    ...
    {
        private static readonly string[] FirstNamesMan = File.ReadAllLines(@"..\..\Files\FirstNamesMan.txt");
        private static readonly string[] LastNamesMan = File.ReadAllLines(@"..\..\Files\LastNamesMan.txt");
        private static readonly string[] SecondNamesMan = File.ReadAllLines(@"..\..\Files\SecondNamesMan.txt");
        private static readonly string[] FirstNamesWoman = File.ReadAllLines(@"..\..\Files\FirstNamesWoman.txt");
        private static readonly string[] LastNamesWoman = File.ReadAllLines(@"..\..\Files\LastNamesWoman.txt");
        private static readonly string[] SecondNamesWoman = File.ReadAllLines(@"..\..\Files\SecondNamesWoman.txt");
        private static readonly string[] Addresses = File.ReadAllLines(@"..\..\Files\Cities.txt");
        private static readonly string[] ProductNames = File.ReadAllLines(@"..\..\Files\Products.txt");
